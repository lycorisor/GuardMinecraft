...
func Get() (data Data, err error) {
	...
	clientID := data.Response.Config.ClientID
	...
	data.Reversed = reserved

	/*v4 := Resp.Config.Interface.Addresses.V4
	v6 := Resp.Config.Interface.Addresses.V6

	fmt.Println("device_id:", Resp.ID)
	fmt.Println("token:", Resp.Token)
	fmt.Println("account_id:", Resp.Account.ID)
	fmt.Println("account_type:", Resp.Account.AccountType)
	fmt.Println("license:", Resp.Account.License)
	fmt.Println("private_key:", privateKey)
	fmt.Println("public_key:", Resp.Config.Peers[0].PublicKey)
	fmt.Println("client_id:", Resp.Config.ClientID)
	fmt.Println("reserved: [", strings.Trim(strings.Join(strings.Fields(fmt.Sprint(reserved)), ", "), "[]"), "]")
	fmt.Println("v4:", v4)
	fmt.Println("v6:", v6)
	fmt.Println("endpoint:", Resp.Config.Peers[0].Endpoint.Host)*/
	return
}
